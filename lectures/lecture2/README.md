# `fk_symbolic_2dof_planar` and `rest_to_rest_joint_trajectory` 
...
Once in the server select the notebook `fk_symbolic_2dof_planar.ipynb` or `rest_to_rest_joint_trajectory.ipynb`. 
